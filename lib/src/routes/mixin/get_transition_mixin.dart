...
import 'package:mit_x/src/routes/transition/default_transitions.dart';
...
Cannot read the previousTitle for a route that has not yet been installed''',
  ...
  static Widget buildPageTransitions<T>(
    ...
    final finalCurve = route.curve ?? MitX.defaultTransitionCurve;
    ...
    if (route.fullscreenDialog && route.transition == null) {
      ...
      if (route.customTransition != null) {
        return route.customTransition!.buildTransition(
          ...
          animation,
          secondaryAnimation,
          route.popGesture ?? MitX.defaultPopGesture
      ...
      switch (route.transition ?? MitX.defaultTransition) {
        ...
        case Transition.noTransition:
          return route.popGesture ?? MitX.defaultPopGesture
              ? CupertinoBackGestureDetector<T>(
                  gestureWidth:
                      route.gestureWidth?.call(context) ?? _kBackGestureWidth,
                  enabledCallback: () => _isPopGestureEnabled<T>(route),
        ...
        default:
          if (MitX.customTransition != null) {
            return MitX.customTransition!.buildTransition(context, route.curve,
