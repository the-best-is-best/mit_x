...
import 'package:mit_x/src/listener/list_notifier.dart';
import 'package:mit_x/src/routes/config/get_nav_config.dart';
import 'package:mit_x/src/routes/mit_route.dart';
import 'package:mit_x/src/routes/observer/route_observer.dart';
import 'package:mit_x/src/static/static_data.dart';
...
class GetDelegate extends RouterDelegate<GetNavConfig>
  ...
  final MitXPage notFoundRoute;

  final List<NavigatorObserver>? navigatorObservers;
  final TransitionDelegate<dynamic>? transitionDelegate;

  final _allCompleters = <MitXPage, Completer>{};

  GetDelegate({
    MitXPage? notFoundRoute,
    ...
    MitX.log('GetDelegate is created !');
  }
  ...
  GlobalKey<NavigatorState> get navigatorKey => StaticData.navigateKey;
  ...
  List<MitXPage> getVisualPages() {
    final currentHistory = currentConfiguration;
    if (currentHistory == null) return <MitXPage>[];
  ...
  Future<T> toNamed<T>(
    ...
    final decoder = MitX.routeTree.matchRoute(page, arguments: arguments);
