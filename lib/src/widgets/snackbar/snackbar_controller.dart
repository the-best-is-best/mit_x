...
class SnackbarController {
  ...
  /// Adds MitXSnackbar to a view queue.
  /// Only one MitXSnackbar will be displayed at a time, and this method returns
  ...
  void _configureOverlay() {
    _overlayState = Overlay.of(MitX.overlayContext!);
